...
#To Put Records
aws kinesis put-record --stream-name ${stream-name} --data ${data} --partition-key ${key}
aws kinesis put-record --stream-name aws-stream --data "This is Pranav" --partition-key "user1"
